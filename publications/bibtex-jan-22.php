    ...
    class BibTeX_Parser
    {
        ...
        function htmlPublication($type, $fields, $element) {
            ...
            if ($this->lastType != $this->sortedItems['type'][$element]){
                ...
                // Demetris
                array_push($this->type, $this->sortedItems['type'][$element]);
            }
		...
		function printPublications() {
            ...
            //echo '<li><a href="#" class="btn btn-xs btn-warning current" data-filter="award">Awards</a></li>';
            //for ($i = 0; $i <= count($this->type); $i++ ) {
            //    echo '<li><a href="#" class="btn btn-xs btn-primary" data-filter=".'.$this->type[$i].'">'.$this->type[$i].'</a></li>';
            //}

<?php
	...
	var $resultedHtml;
		...
		$this->resultedHtml .= '<div style="display:none"><div id="bibtex-'.$element.'"><pre>'.$this->sortedItems['raw'][$element].'</pre></div></div>';
            ...
            if (isset($this->sortedItems['video'][$element])) {
                $this->resultedHtml .= '<a target="_blank" title="Video" class="publications-title" href="'.$this->sortedItems['video'][$element].'"><i class="fa fa-file-video-o">&nbsp;</i></a>';
            }
